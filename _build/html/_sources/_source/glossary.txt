...
.. glossary::
	...
	Ephemeral storage
		...
		It is associated with a single unique instance. Based on the instance, the size is defined. When the instance associated with it is terminated, data on ephemeral storage ceases to exist.
	...
	Volume Storage
		...
		This storage is not dependent on any perticular instance and is persistent. Volumes are user created and within Quota.
